...
public class ThemesLoader {
	...
	public boolean loadThemes(List<String> skeletons, boolean newThemes, boolean manuallyCreated) {
		if (skeletons == null) {
			return false;
		}
		boolean result = true;
	...
	protected String createNewTheme(String originalUri, String encodedUri, boolean newTheme, boolean manuallyCreated) {
