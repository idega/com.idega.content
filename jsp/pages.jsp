...
version="1.2">
	...
	<jsf:view>
		<ws:page id="pages" javascripturls="/dwr/engine.js,
			...
			<h:form id="pagesForm">
				<jsf:verbatim>
                	<script type="text/javascript">initScript(false);getThemes(null);</script>
                </jsf:verbatim>
                
                <wf:wfblock id="pagesBlock" title="#{localizedStrings['com.idega.content']['pages']}">
					...
					<c:PageInfo id="customizePage"></c:PageInfo>
