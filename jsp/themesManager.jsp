...
<jsp:directive.page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8"/>
	<jsf:view>
        <ws:page id="themeManager" javascripturls="/dwr/engine.js,
			...
			<jsf:verbatim>
				<script type="text/javascript">insertStyleFile();</script>
				<script type="text/javascript">initScript(false, true, true);</script>
				<script type="text/javascript">getThemes(null, true);</script>
			</jsf:verbatim>
        </ws:page>
	</jsf:view>
</jsp:root>